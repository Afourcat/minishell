...
Test(setenv, basic_test)
{
	...
	cr_assert_str_eq(lolo, "name is lolo", "Should be name is lolo but it's %s\n", lolo);
	cr_assert_str_eq(name, "salut comment tu vas", "Should be salut comment tu vas but it's %s\n", name);
}
...
Test(setenv, two_set)
{
	...
	cr_assert_str_eq(epitech, "lililopzaoepoape", "Should be name is lolo but it's %s\n", epitech);
	cr_assert_str_eq(salam, "Beurette a chicha", "Should be Beurette a chicha but it's %s\n", salam);
}
...
Test(unsetenv, basic_test)
{
	...
	cr_assert_str_eq(epitech, "lolilkl", "Should be lolilo but it's %s\n", epitech);
	cr_assert_str_eq(salam, "Beurette a chicha", "Should be Beurette a chicha but it's %s\n", salam);
}
